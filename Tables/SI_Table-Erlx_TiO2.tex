\begin{table}
\caption{\label{tab:lattice_parameters_tio2}Relaxation energy $E_\text{rlx}$ (in meV) for the adsorbate--surface systems with the \ce{TiO2} surfaces obtained from the DFT ensemble.}
