...
\begin{table}
\caption{\label{tab:system_eint_mgo_ch4}$E_\textrm{int}$ (in meV) of the SKZCAM clusters for \ce{CH4} on MgO (001). The clusters correspond to the `Mg-centered MgO (001)' type visualized in Figure~\ref{fig:skzcam_clusters}.}
...
\begin{table}
\caption{\label{tab:system_eint_mgo_ch4_monolayer}$E_\textrm{int}$ (in meV) of the SKZCAM clusters for Monolayer \ce{CH4} on MgO (001). The clusters correspond to the `Mg-centered MgO (001)' type visualized in Figure~\ref{fig:skzcam_clusters}.}
\begin{adjustbox}{center,max width=1.4\textwidth}
\begin{tabular}{lrrrrrrr}
\toprule
 & 1 & 2 & 3 & 4 & 5 & 6 & 7 \\ 
...
\begin{table}
\caption{\label{tab:system_eint_mgo_c2h6}$E_\textrm{int}$ (in meV) of the SKZCAM clusters for \ce{C2H6} on MgO (001). The clusters correspond to the `Mg-centered MgO (001)' type visualized in Figure~\ref{fig:skzcam_clusters}.}
\begin{adjustbox}{center,max width=1.4\textwidth}
\begin{tabular}{lrrrrrrr}
\toprule
 & 1 & 2 & 3 & 4 & 5 & 6 & 7 \\ 
...
\begin{table}
\caption{\label{tab:system_eint_mgo_c2h6_monolayer}$E_\textrm{int}$ (in meV) of the SKZCAM clusters for Monolayer \ce{C2H6} on MgO (001). The clusters correspond to the `Mg-centered MgO (001)' type visualized in Figure~\ref{fig:skzcam_clusters}.}
\begin{adjustbox}{center,max width=1.4\textwidth}
\begin{tabular}{lrrrrrrr}
\toprule
 & 1 & 2 & 3 & 4 & 5 & 6 & 7 \\ 
...
\begin{table}
\caption{\label{tab:system_eint_mgo_co}$E_\textrm{int}$ (in meV) of the SKZCAM clusters for \ce{CO} on MgO (001). The clusters correspond to the `Mg-centered MgO (001)' type visualized in Figure~\ref{fig:skzcam_clusters}.}
\begin{adjustbox}{center,max width=1.4\textwidth}
\begin{tabular}{lrrrrrrr}
\toprule
 & 1 & 2 & 3 & 4 & 5 & 6 & 7 \\ 
...
\begin{table}
\caption{\label{tab:system_eint_mgo_c6h6}$E_\textrm{int}$ (in meV) of the SKZCAM clusters for \ce{C6H6} on MgO (001). The clusters correspond to the `O-centered MgO (001)' type visualized in Figure~\ref{fig:skzcam_clusters}.}
\begin{adjustbox}{center,max width=1.4\textwidth}
\begin{tabular}{lrrrrrrr}
\toprule
 & 1 & 2 & 3 & 4 & 5 & 6 & 7 \\ 
...
\begin{table}
\caption{\label{tab:system_eint_mgo_n2o_parallel}$E_\textrm{int}$ (in meV) of the SKZCAM clusters for Parallel \ce{N2O} on MgO (001). The clusters correspond to the `Hollow-centered MgO (001)' type visualized in Figure~\ref{fig:skzcam_clusters}.}
\begin{adjustbox}{center,max width=1.4\textwidth}
\begin{tabular}{lrrrrrrr}
\toprule
 & 1 & 2 & 3 & 4 & 5 & 6 & 7 \\ 
...
\begin{table}
\caption{\label{tab:system_eint_mgo_n2o_tilted}$E_\textrm{int}$ (in meV) of the SKZCAM clusters for Tilted \ce{N2O} on MgO (001). The clusters correspond to the `Mg-centered MgO (001)' type visualized in Figure~\ref{fig:skzcam_clusters}.}
\begin{adjustbox}{center,max width=1.4\textwidth}
\begin{tabular}{lrrrrrrr}
\toprule
 & 1 & 2 & 3 & 4 & 5 & 6 & 7 \\ 
...
\begin{table}
\caption{\label{tab:system_eint_mgo_no_vertical-hollow}$E_\textrm{int}$ (in meV) of the SKZCAM clusters for Vertical-Hollow \ce{NO} on MgO (001). The clusters correspond to the `Hollow-centered MgO (001)' type visualized in Figure~\ref{fig:skzcam_clusters}.}
\begin{adjustbox}{center,max width=1.4\textwidth}
\begin{tabular}{lrrrrrrr}
\toprule
 & 1 & 2 & 3 & 4 & 5 & 6 & 7 \\ 
...
\begin{table}
\caption{\label{tab:system_eint_mgo_no_vertical-mg}$E_\textrm{int}$ (in meV) of the SKZCAM clusters for Vertical-Mg \ce{NO} on MgO (001). The clusters correspond to the `Mg-centered MgO (001)' type visualized in Figure~\ref{fig:skzcam_clusters}.}
\begin{adjustbox}{center,max width=1.4\textwidth}
\begin{tabular}{lrrrrrrr}
\toprule
 & 1 & 2 & 3 & 4 & 5 & 6 & 7 \\ 
...
\begin{table}
\caption{\label{tab:system_eint_mgo_no_bent-bridge}$E_\textrm{int}$ (in meV) of the SKZCAM clusters for Bent-Bridge \ce{NO} on MgO (001). The clusters correspond to the `Mg-centered MgO (001)' type visualized in Figure~\ref{fig:skzcam_clusters}.}
\begin{adjustbox}{center,max width=1.4\textwidth}
\begin{tabular}{lrrrrrrr}
\toprule
 & 1 & 2 & 3 & 4 & 5 & 6 & 7 \\ 
...
\begin{table}
\caption{\label{tab:system_eint_mgo_no_bent-mg}$E_\textrm{int}$ (in meV) of the SKZCAM clusters for Bent-Mg \ce{NO} on MgO (001). The clusters correspond to the `Mg-centered MgO (001)' type visualized in Figure~\ref{fig:skzcam_clusters}.}
\begin{adjustbox}{center,max width=1.4\textwidth}
\begin{tabular}{lrrrrrrr}
\toprule
 & 1 & 2 & 3 & 4 & 5 & 6 & 7 \\ 
...
\begin{table}
\caption{\label{tab:system_eint_mgo_no_bent-o}$E_\textrm{int}$ (in meV) of the SKZCAM clusters for Bent-O \ce{NO} on MgO (001). The clusters correspond to the `O-centered MgO (001)' type visualized in Figure~\ref{fig:skzcam_clusters}.}
\begin{adjustbox}{center,max width=1.4\textwidth}
\begin{tabular}{lrrrrrrr}
\toprule
 & 1 & 2 & 3 & 4 & 5 & 6 & 7 \\ 
...
\begin{table}
\caption{\label{tab:system_eint_mgo_no_dimer}$E_\textrm{int}$ (in meV) of the SKZCAM clusters for Dimer \ce{NO} on MgO (001). The clusters correspond to the `Hollow-centered MgO (001)' type visualized in Figure~\ref{fig:skzcam_clusters}.}
\begin{adjustbox}{center,max width=1.4\textwidth}
\begin{tabular}{lrrrrrrr}
\toprule
 & 1 & 2 & 3 & 4 & 5 & 6 & 7 \\ 
...
\begin{table}
\caption{\label{tab:system_eint_mgo_h2o_monomer}$E_\textrm{int}$ (in meV) of the SKZCAM clusters for Monomer \ce{H2O} on MgO (001). The clusters correspond to the `Mg-centered MgO (001)' type visualized in Figure~\ref{fig:skzcam_clusters}.}
\begin{adjustbox}{center,max width=1.4\textwidth}
\begin{tabular}{lrrrrrrr}
\toprule
 & 1 & 2 & 3 & 4 & 5 & 6 & 7 \\ 
...
\begin{table}
\caption{\label{tab:system_eint_mgo_h2o_tetramer}$E_\textrm{int}$ (in meV) of the SKZCAM clusters for Tetramer \ce{H2O} on MgO (001). The clusters correspond to the `O-centered MgO (001)' type visualized in Figure~\ref{fig:skzcam_clusters}.}
\begin{adjustbox}{center,max width=1.4\textwidth}
\begin{tabular}{lrrrrrrr}
\toprule
 & 1 & 2 & 3 & 4 & 5 & 6 & 7 \\ 
...
\begin{table}
\caption{\label{tab:system_eint_mgo_ch3oh_tilted}$E_\textrm{int}$ (in meV) of the SKZCAM clusters for Tilted \ce{CH3OH} on MgO (001). The clusters correspond to the `Mg-centered MgO (001)' type visualized in Figure~\ref{fig:skzcam_clusters}.}
\begin{adjustbox}{center,max width=1.4\textwidth}
\begin{tabular}{lrrrrrrr}
\toprule
 & 1 & 2 & 3 & 4 & 5 & 6 & 7 \\ 
...
\begin{table}
\caption{\label{tab:system_eint_mgo_ch3oh_parallel}$E_\textrm{int}$ (in meV) of the SKZCAM clusters for Parallel \ce{CH3OH} on MgO (001). The clusters correspond to the `Mg-centered MgO (001)' type visualized in Figure~\ref{fig:skzcam_clusters}.}
\begin{adjustbox}{center,max width=1.4\textwidth}
\begin{tabular}{lrrrrrrr}
\toprule
 & 1 & 2 & 3 & 4 & 5 & 6 & 7 \\ 
...
\begin{table}
\caption{\label{tab:system_eint_mgo_ch3oh_tetramer}$E_\textrm{int}$ (in meV) of the SKZCAM clusters for Tetramer \ce{CH3OH} on MgO (001). The clusters correspond to the `O-centered MgO (001)' type visualized in Figure~\ref{fig:skzcam_clusters}.}
\begin{adjustbox}{center,max width=1.4\textwidth}
\begin{tabular}{lrrrrrrr}
\toprule
 & 1 & 2 & 3 & 4 & 5 & 6 & 7 \\ 
...
\begin{table}
\caption{\label{tab:system_eint_mgo_nh3}$E_\textrm{int}$ (in meV) of the SKZCAM clusters for \ce{NH3} on MgO (001). The clusters correspond to the `Mg-centered MgO (001)' type visualized in Figure~\ref{fig:skzcam_clusters}.}
\begin{adjustbox}{center,max width=1.4\textwidth}
\begin{tabular}{lrrrrrrr}
\toprule
 & 1 & 2 & 3 & 4 & 5 & 6 & 7 \\ 
...
\begin{table}
\caption{\label{tab:system_eint_mgo_co2_physisorbed}$E_\textrm{int}$ (in meV) of the SKZCAM clusters for Physisorbed \ce{CO2} on MgO (001). The clusters correspond to the `Hollow-centered MgO (001)' type visualized in Figure~\ref{fig:skzcam_clusters}.}
\begin{adjustbox}{center,max width=1.4\textwidth}
\begin{tabular}{lrrrrrrr}
\toprule
 & 1 & 2 & 3 & 4 & 5 & 6 & 7 \\ 
...
\begin{table}
\caption{\label{tab:system_eint_mgo_co2_chemisorbed}$E_\textrm{int}$ (in meV) of the SKZCAM clusters for Chemisorbed \ce{CO2} on MgO (001). The clusters correspond to the `none' type visualized in Figure~\ref{fig:skzcam_clusters}.}
\begin{adjustbox}{center,max width=1.4\textwidth}
\begin{tabular}{lrrrrrrr}
\toprule
 & 1 & 2 & 3 & 4 & 5 & 6 & 7 \\ 
...
\begin{table}
\caption{\label{tab:system_eint_r-tio2_ch4}$E_\textrm{int}$ (in meV) of the SKZCAM clusters for \ce{CH4} on \ce{TiO2} rutile (110). The clusters correspond to the `\ce{TiO2} rutile (110)' type visualized in Figure~\ref{fig:skzcam_clusters}.}
\begin{adjustbox}{center,max width=1.4\textwidth}
\begin{tabular}{lrrrrrrr}
\toprule
 & 1 & 2 & 3 & 4 & 5 & 6 & 7 \\ 
...
\begin{table}
\caption{\label{tab:system_eint_r-tio2_co2_parallel}$E_\textrm{int}$ (in meV) of the SKZCAM clusters for Parallel \ce{CO2} on \ce{TiO2} rutile (110). The clusters correspond to the `\ce{TiO2} rutile (110)' type visualized in Figure~\ref{fig:skzcam_clusters}.}
\begin{adjustbox}{center,max width=1.4\textwidth}
\begin{tabular}{lrrrrrrr}
\toprule
 & 1 & 2 & 3 & 4 & 5 & 6 & 7 \\ 
...
\begin{table}
\caption{\label{tab:system_eint_r-tio2_co2_tilted}$E_\textrm{int}$ (in meV) of the SKZCAM clusters for Tilted \ce{CO2} on \ce{TiO2} rutile (110). The clusters correspond to the `\ce{TiO2} rutile (110)' type visualized in Figure~\ref{fig:skzcam_clusters}.}
\begin{adjustbox}{center,max width=1.4\textwidth}
\begin{tabular}{lrrrrrrr}
\toprule
 & 1 & 2 & 3 & 4 & 5 & 6 & 7 \\ 
...
\begin{table}
\caption{\label{tab:system_eint_r-tio2_h2o}$E_\textrm{int}$ (in meV) of the SKZCAM clusters for \ce{H2O} on \ce{TiO2} rutile (110). The clusters correspond to the `\ce{TiO2} rutile (110)' type visualized in Figure~\ref{fig:skzcam_clusters}.}
\begin{adjustbox}{center,max width=1.4\textwidth}
\begin{tabular}{lrrrrrrr}
\toprule
 & 1 & 2 & 3 & 4 & 5 & 6 & 7 \\ 
...
\begin{table}
\caption{\label{tab:system_eint_r-tio2_ch3oh}$E_\textrm{int}$ (in meV) of the SKZCAM clusters for \ce{CH3OH} on \ce{TiO2} rutile (110). The clusters correspond to the `\ce{TiO2} rutile (110)' type visualized in Figure~\ref{fig:skzcam_clusters}.}
\begin{adjustbox}{center,max width=1.4\textwidth}
\begin{tabular}{lrrrrrrr}
\toprule
 & 1 & 2 & 3 & 4 & 5 & 6 & 7 \\ 
...
\begin{table}
\caption{\label{tab:system_eint_a-tio2_h2o}$E_\textrm{int}$ (in meV) of the SKZCAM clusters for \ce{H2O} on \ce{TiO2} anatase (101). The clusters correspond to the `\ce{TiO2} anatase (101)' type visualized in Figure~\ref{fig:skzcam_clusters}.}
\begin{adjustbox}{center,max width=1.4\textwidth}
\begin{tabular}{lrrrrrrr}
\toprule
 & 1 & 2 & 3 & 4 & 5 & 6 & 7 \\ 
...
\begin{table}
\caption{\label{tab:system_eint_a-tio2_nh3}$E_\textrm{int}$ (in meV) of the SKZCAM clusters for \ce{NH3} on \ce{TiO2} anatase (101). The clusters correspond to the `\ce{TiO2} anatase (101)' type visualized in Figure~\ref{fig:skzcam_clusters}.}
\begin{adjustbox}{center,max width=1.4\textwidth}
\begin{tabular}{lrrrrrrr}
\toprule
 & 1 & 2 & 3 & 4 & 5 & 6 & 7 \\ 
