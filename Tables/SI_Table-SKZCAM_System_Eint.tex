...
\caption{\label{tab:skzcam_system_eint} $E_\textrm{int}$ (in meV) of the SKZCAM clusters for the 19 molecule-surface systems (and their studied adsorption configurations). The type of clusters used is given within the brackets and the corresponding size for each cluster is provided in Figure~\ref{fig:skzcam_clusters}.} \\
